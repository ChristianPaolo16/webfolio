    ...
    return(
        <div id='projects' className="flex flex-col pt-10">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center mt-10">
                <img alt="Porfolio" src="https://res.cloudinary.com/dr4rwlp7t/image/upload/v1677816869/webportfolio/firstPortfolio_sxibt4.png" className="w-4/5 lg:w-2/5"/>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center mt-10">
                <img alt="Paradise" src="https://res.cloudinary.com/dr4rwlp7t/image/upload/v1677822118/webportfolio/paradise_srfilx.png" className="w-4/5 lg:w-2/5"/>
                <div className="flex flex-col lg:ml-8 lg:mt-12 mt-6 w-3/4 lg:w-2/5">
